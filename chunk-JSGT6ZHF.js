...
`,Ai={root:({props:t,instance:o})=>["p-badge p-component",{"p-badge-circle":wt(t.value)&&String(t.value).length===1,"p-badge-dot":ue(t.value)&&!o.$slots.default,"p-badge-sm":t.size==="small","p-badge-lg":t.size==="large","p-badge-xl":t.size==="xlarge","p-badge-info":t.severity==="info","p-badge-success":t.severity==="success","p-badge-warn":t.severity==="warn","p-badge-danger":t.severity==="danger","p-badge-secondary":t.severity==="secondary","p-badge-contrast":t.severity==="contrast"}]},ao=(()=>{class t extends k{name="badge";theme=Fi;classes=Ai;static \u0275fac=(()=>{let e;return function(i){return(e||(e=f(t)))(i||t)}})();static \u0275prov=I({token:t,factory:t.\u0275fac})}return t})();var Lt=(()=>{class t extends N{styleClass=J();style=J();badgeSize=J();size=J();severity=J();value=J();badgeDisabled=J(!1,{transform:w});_componentStyle=b(ao);containerClass=ie(()=>{let e="p-badge p-component";return wt(this.value())&&String(this.value()).length===1&&(e+=" p-badge-circle"),this.badgeSize()==="large"?e+=" p-badge-lg":this.badgeSize()==="xlarge"?e+=" p-badge-xl":this.badgeSize()==="small"&&(e+=" p-badge-sm"),ue(this.value())&&(e+=" p-badge-dot"),this.styleClass()&&(e+=` ${this.styleClass()}`),this.severity()&&(e+=` p-badge-${this.severity()}`),e});static \u0275fac=(()=>{let e;return function(i){return(e||(e=f(t)))(i||t)}})();static \u0275cmp=x({type:t,selectors:[["p-badge"]],hostVars:6,hostBindings:function(n,i){n&2&&(en(i.style()),te(i.containerClass()),Jt("display",i.badgeDisabled()?"none":null))},inputs:{styleClass:[1,"styleClass"],style:[1,"style"],badgeSize:[1,"badgeSize"],size:[1,"size"],severity:[1,"severity"],value:[1,"value"],badgeDisabled:[1,"badgeDisabled"]},features:[D([ao]),y],decls:1,vars:1,template:function(n,i){n&1&&p(0),n&2&&X(i.value())},dependencies:[Z,q],encapsulation:2,changeDetection:0})}return t})(),lo=(()=>{class t{static \u0275fac=function(n){return new(n||t)};static \u0275mod=z({type:t});static \u0275inj=j({imports:[Lt,q,q]})}return t})();var Oi=["content"],Ti=["loadingicon"],Pi=["icon"],Ni=["*"],uo=t=>({class:t});function Bi(t,o){t&1&&he(0)}function Li(t,o){if(t&1&&h(0,"span",8),t&2){let e=g(3);a("ngClass",e.iconClass()),$("aria-hidden",!0)("data-pc-section","loadingicon")}}function Ri(t,o){if(t&1&&h(0,"SpinnerIcon",9),t&2){let e=g(3);a("styleClass",e.spinnerIconClass())("spin",!0),$("aria-hidden",!0)("data-pc-section","loadingicon")}}function ji(t,o){if(t&1&&(He(0),C(1,Li,1,3,"span",6)(2,Ri,1,4,"SpinnerIcon",7),ze()),t&2){let e=g(2);u(),a("ngIf",e.loadingIcon),u(),a("ngIf",!e.loadingIcon)}}function Hi(t,o){}function zi(t,o){if(t&1&&C(0,Hi,0,0,"ng-template",10),t&2){let e=g(2);a("ngIf",e.loadingIconTemplate||e._loadingIconTemplate)}}function Wi(t,o){if(t&1&&(He(0),C(1,ji,3,2,"ng-container",2)(2,zi,1,1,null,5),ze()),t&2){let e=g();u(),a("ngIf",!e.loadingIconTemplate&&!e._loadingIconTemplate),u(),a("ngTemplateOutlet",e.loadingIconTemplate||e._loadingIconTemplate)("ngTemplateOutletContext",ne(3,uo,e.iconClass()))}}function Gi(t,o){if(t&1&&h(0,"span",8),t&2){let e=g(2);te(e.icon),a("ngClass",e.iconClass()),$("data-pc-section","icon")}}function Ui(t,o){}function qi(t,o){if(t&1&&C(0,Ui,0,0,"ng-template",10),t&2){let e=g(2);a("ngIf",!e.icon&&(e.iconTemplate||e._iconTemplate))}}function Yi(t,o){if(t&1&&(He(0),C(1,Gi,1,4,"span",11)(2,qi,1,1,null,5),ze()),t&2){let e=g();u(),a("ngIf",e.icon&&!e.iconTemplate&&!e._iconTemplate),u(),a("ngTemplateOutlet",e.iconTemplate||e._iconTemplate)("ngTemplateOutletContext",ne(3,uo,e.iconClass()))}}function Qi(t,o){if(t&1&&(l(0,"span",12),p(1),c()),t&2){let e=g();$("aria-hidden",e.icon&&!e.label)("data-pc-section","label"),u(),X(e.label)}}function Xi(t,o){if(t&1&&h(0,"p-badge",13),t&2){let e=g();a("value",e.badge)("severity",e.badgeSeverity)}}var Zi=({dt:t})=>`
.p-button {
    display: inline-flex;
    cursor: pointer;
    user-select: none;
